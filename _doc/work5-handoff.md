...
- work5 는 **Phase 6 구현 완료 → QEMU smoke 대기 → Phase 7 진입 직전** 단계다.
- Phase 1 코드 변경:
...
10. Phase 7 polish 들어갈 때 menu 가 열려 있을 때 키보드 누수(현재 화살표/Enter/Esc 만
    consume, 그 외 char 는 underlying app 으로 leak) 를 막는 게 자연스러운 후보.
