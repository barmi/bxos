...
- work5 는 **Phase 7 구현 완료 → QEMU smoke 대기 → Phase 8 진입 직전** 단계다.
- Phase 1 코드 변경:
...
11. Phase 8 진입 시 BXOS-COMMANDS / README / SETUP / he2-format 문서 갱신과
    QEMU full smoke (모든 Phase 항목) 가 핵심 작업이다.
