...
- work5 는 **Phase 2 구현 완료 → QEMU visual smoke 대기 → Phase 3 진입 직전** 단계다.
- Phase 1 코드 변경:
...
- 미존재:
  - MENU.CFG loader, 실제 handler dispatch, 실제 system tray 시계, taskbar window list, Alt+Tab.
...
5. **Phase 3 진입** — mkfat12.py 가 flat root 만 지원하는 점에 유의:
