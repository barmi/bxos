...
;VBEMODE	EQU		0x117			; 1024 x  768 x 16 bit 칼라
; (화면 모드 일람)
...
;	0x111 :  640 x  480 x 16 bit 칼라
;	0x114 :  800 x  600 x 16 bit 칼라
;	0x117 : 1024 x  768 x 16 bit 칼라
;	0x11A : 1280 x 1024 x 16 bit 칼라
